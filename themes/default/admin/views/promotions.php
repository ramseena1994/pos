        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">POS Module Impulsion Technologies</h1>
                    <p class="lead">Impulsion Pos is web application for small and medium business to manage inventory, sales (with online payments), expenses, customers and warehouses. </p>
                    
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>Impulsion Pos by <a href="http://tecdiary.com">Izhar</a>.</p>
                    </div>
                </div>
            </div>
        </div>
