...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_service'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("services/add", $attrib)
                ?>
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <?php echo form_submit('add_service', $this->lang->line("add_service"), 'class="btn btn-primary"'); ?>
                    </div>
