                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-info">
                                ...
                                <?php 
                                echo "<img src='" . base_url('assets/images/car1.png') . "' width='400px'/>";
                                echo "<img src='" . base_url('assets/images/car2.png') . "' width='400px'/>";
                                ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("11", "11"); ?>
                                                <?php echo form_input('s11', (isset($_POST['s11']) ? $_POST['s11'] : ""), 'class="form-control input-tip" id="s11"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("12", "12"); ?>
                                                <?php echo form_input('s12', (isset($_POST['s12']) ? $_POST['s12'] : ""), 'class="form-control input-tip" id="s12"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("13", "13"); ?>
                                                <?php echo form_input('s13', (isset($_POST['s13']) ? $_POST['s13'] : ""), 'class="form-control input-tip" id="s13"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("14", "14"); ?>
                                                <?php echo form_input('s14', (isset($_POST['s14']) ? $_POST['s14'] : ""), 'class="form-control input-tip" id="s14"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("15", "15"); ?>
                                                <?php echo form_input('s15', (isset($_POST['s15']) ? $_POST['s15'] : ""), 'class="form-control input-tip" id="s15"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("16", "16"); ?>
                                                <?php echo form_input('s16', (isset($_POST['s16']) ? $_POST['s16'] : ""), 'class="form-control input-tip" id="s16"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("17", "17"); ?>
                                                <?php echo form_input('s17', (isset($_POST['s17']) ? $_POST['s17'] : ""), 'class="form-control input-tip" id="s17"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("18", "18"); ?>
                                                <?php echo form_input('s18', (isset($_POST['s18']) ? $_POST['s18'] : ""), 'class="form-control input-tip" id="s18"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("19", "19"); ?>
                                                <?php echo form_input('s19', (isset($_POST['s19']) ? $_POST['s19'] : ""), 'class="form-control input-tip" id="s19"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("20", "20"); ?>
                                                <?php echo form_input('s20', (isset($_POST['s20']) ? $_POST['s20'] : ""), 'class="form-control input-tip" id="s20"'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <?= lang("21", "21"); ?>
                                                <?php echo form_input('s21', (isset($_POST['s21']) ? $_POST['s21'] : ""), 'class="form-control input-tip" id="s21"'); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12" id="sticker">
                            <div class="well well-sm">
                                ...
                                <div class="col-sm-12">
                                    <div
                                    class="form-group"><?php echo form_submit('add_quote', $this->lang->line("submit"), 'id="add_quote" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
