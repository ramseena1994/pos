...
<div id="wrap">
                ...
                <div class="col-xs-6">
                    <div class="bold">
                        ...
                        <div class="order_barcodes">
                            ...
                            <?php /*echo $this->sma->qrcode('link', urlencode(admin_url('quotes/view/' . $inv->id)), 2);*/ ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
 ...
 <!--             <div class="col-xs-12">
             ...
             <div class="clearfix"></div>
             <div class="col-md-1">
                <b>11</b> : <?php echo $inv->s11; ?>
            </div>
            <div class="col-md-1">
                <b>12</b> : <?php echo $inv->s12; ?>
            </div>
            <div class="col-md-1">
                <b>13</b> : <?php echo $inv->s13; ?>
            </div>
            <div class="col-md-1">
                <b>14</b> : <?php echo $inv->s14; ?>
            </div>
            <div class="col-md-1">
                <b>15</b> : <?php echo $inv->s15; ?>
            </div>
            <div class="col-md-1">
                <b>16</b> : <?php echo $inv->s16; ?>
            </div>
            <div class="col-md-1">
                <b>17</b> : <?php echo $inv->s17; ?>
            </div>
            <div class="col-md-1">
                <b>18</b> : <?php echo $inv->s18; ?>
            </div>
            <div class="col-md-1">
                <b>19</b> : <?php echo $inv->s19; ?>
            </div>
            <div class="col-md-1">
                <b>20</b> : <?php echo $inv->s20; ?>
            </div>
            <div class="col-md-1">
                <b>21</b> : <?php echo $inv->s21; ?>
            </div> -->
            <div class="col-xs-12">
