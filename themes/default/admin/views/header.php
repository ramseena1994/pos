                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="services_index">
                                        <a class="submenu" href="<?= admin_url('services'); ?>">
                                            <i class="fa fa-barcode"></i>
                                            <span class="text"> <?= lang('list_services'); ?></span>
                                        </a>
                                    </li>
                                    <li id="services_add">
                                        <a class="submenu" href="<?= admin_url('services/add'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('add_service'); ?></span>
                                        </a>
                                    </li>
